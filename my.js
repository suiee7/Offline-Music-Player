...
let track_list = [
{
  ...
  path: "C:/Users/SURYA/Music/Bulleya.mp3"
},
{
	name: "New Rules",
	artist: "Dua Lipa",
	path: "C:/Users/SURYA/Music/NewRules.flac"
},
{
	name: "Dont Let Me Down",
	artist: "ChainSmokers",
	path: "C:/Users/SURYA/Music/DontLetMeDown.flac",
},
];
...
//Moving to the next track if the current finishes playing using the 'ended' event
...
//Constructing a color withe the given values
let rbgColor = "rgb(" + red + ", " + green + ", " + blue + ")";
...
//Check if the current track duration is an elegible number
